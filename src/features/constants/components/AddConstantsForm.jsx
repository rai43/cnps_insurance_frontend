...
const AddConstantsForm = (props) => {
  ...
  const saveConstant = async (collectedJsonValues) => {
    const response = await axios.post(
      "http://localhost:9000/api/constants",
      collectedJsonValues,
      {
        headers: {
  ...
  const submitForm = async (values) => {
    ...
    toast.promise(saveConstant(collectedJsonValues), {
      ...
      error: () => {
        return (
          <span>
            Erreur lors de la création. Verifier l'existence du bénéficiaire et
            réessayer
          </span>
        );
      },
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-x-4 gap-y-1">
              ...
              <InputText
                ...
                defaultValue={
                  modalState.extraObject?.data
                    ? modalState.extraObject.data.card_number
                    : constantsObj().card_number
                }
                containerStyle="mt-1"
                inputStyle={
                  errors("card_number") ? "input-bordered input-error" : ""
                }
            ...
            <div>
              <InputText
                ...
                defaultValue={
                  modalState.extraObject?.data
                    ? modalState.extraObject.data.temperature
                    : constantsObj().temperature
                }
                containerStyle="mt-1"
                inputStyle={
                  errors("temperature") ? "input-bordered input-error" : ""
                }
            ...
            <div>
              <InputText
                ...
                defaultValue={
                  modalState.extraObject?.data
                    ? modalState.extraObject.data.height
                    : constantsObj().height
                }
                containerStyle="mt-1"
                inputStyle={
                  errors("height") ? "input-bordered input-error" : ""
                }
            ...
            <div>
              <InputText
                ...
                defaultValue={
                  modalState.extraObject?.data
                    ? modalState.extraObject.data.weight
                    : constantsObj().weight
                }
                containerStyle="mt-1"
                inputStyle={
                  errors("weight") ? "input-bordered input-error" : ""
                }
                labelTitle="Poids (cm)"
                disabled={isLocked()}
              />
            ...
            <div>
              <InputText
                ...
                defaultValue={
                  modalState.extraObject?.data
                    ? modalState.extraObject.data.pulse
                    : constantsObj().pulse
                }
                containerStyle="mt-1"
            ...
            <div>
              <InputText
                ...
                defaultValue={
                  modalState.extraObject?.data
                    ? modalState.extraObject.data.blood_pressure
                    : constantsObj().blood_pressure
                }
                containerStyle="mt-1"
                inputStyle={
                  errors("blood_pressure") ? "input-bordered input-error" : ""
                }
            ...
            <div class="md:col-span-3 h-full">
              <InputText
                ...
                defaultValue={
                  modalState.extraObject?.data
                    ? modalState.extraObject.data.other
                    : constantsObj().other
                }
                containerStyle="mt-1"
