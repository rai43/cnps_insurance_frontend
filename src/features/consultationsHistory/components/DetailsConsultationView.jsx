        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-x-4 gap-y-1">
          <div>
            <InputText
              ...
              defaultValue={
                modalState.extraObject?.data
                  ? modalState.extraObject.data._id
                  : constantsObj().constant_id
              }
              containerStyle="mt-1"
          ...
          <div class="md:col-span-2">
            <InputText
              ...
              defaultValue={
                modalState.extraObject?.data &&
                modalState.extraObject.data.sickness
              }
          ...
          <div class="md:col-span-3">
            <div class={`form-control w-full mt-1`}>
              ...
              <div class="w-full bg-gray-50 rounded-sm p-4">
                {modalState.extraObject?.data &&
                  modalState.extraObject.data.comments}
              </div>
            </div>
          </div>
        </div>
