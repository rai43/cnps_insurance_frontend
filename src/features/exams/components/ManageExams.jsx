...
const fetchExams = async () =>
  await axios.get(`http://localhost:9000/api/exams`);

const [fetcherSignal, setFetcherSignal] = createSignal(2);

export const [examsRessource, { mutate, refetch }] = createResource(
  fetcherSignal(),
  fetchExams
);
  ...
  return (
    <>
      <Show when={!examsRessource.loading}>
        <TitleCard title={"Liste d'attente des examens"} topMargin="mt-1">
