  ...
  return (
    <>
      ...
      <div class={`modal ${modalState.isOpen ? "modal-open" : ""}`}>
        <div
          class={`modal-box  ${modalState.size === "lg" ? "max-w-5xl" : ""}`}
        >
          <button
          ...
          <h3 class="font-semibold text-2xl pb-6 text-center">
            {modalState.title}
          </h3>
          <Show
            when={
              modalState.bodyType ===
              GLOBAL_CONSTANTS.MODAL_BODY_TYPES.BENEFICIARY_NEW
            }
          >
          ...
          <Show
            when={
              modalState.bodyType ===
              GLOBAL_CONSTANTS.MODAL_BODY_TYPES.CONSTANTS_NEW
            }
          >
          ...
          <Show
            when={
              modalState.bodyType ===
              GLOBAL_CONSTANTS.MODAL_BODY_TYPES.CONSULTATIONS_NEW
            }
          >
          ...
          <Show
            when={
              modalState.bodyType ===
              GLOBAL_CONSTANTS.MODAL_BODY_TYPES.CONSULTATIONS_DONE_DETAILS
            }
          >
          ...
          <Show
            when={
              modalState.bodyType ===
              GLOBAL_CONSTANTS.MODAL_BODY_TYPES.EXAMS_NEW
            }
          >
